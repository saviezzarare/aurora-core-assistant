...
import { X, Search, Building2, Target, MapPin, PieChart, History, Home } from "lucide-react";
      ...
      <>
        ...
        >
          ...
          <div className="p-4 border-t border-primary/10">
            <p className="text-[9px] text-muted-foreground/40 text-center">LUXIUM ASSISTANT v4.0</p>
            <p className="text-[9px] text-muted-foreground/30 text-center">Unimed Bauru · Prospecção</p>
          </div>
        </motion.div>
      </>
    )}
